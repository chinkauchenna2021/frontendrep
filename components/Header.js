...
<div className="lg:flex lg:items-center lg:justify-between align-middle flex-column justify-center sm:flex">
  ...
  <div className="transition-all  w-8 hover:w-3/4 rounded lg:ml-40 top-40  left-50 absolute   flex  lg:top-0 lg:relative   lg:justify-start lg:w-3/4  px-auto" style={{backgroundColor:"#1F1F1F",justifyContent:"center"}}>
